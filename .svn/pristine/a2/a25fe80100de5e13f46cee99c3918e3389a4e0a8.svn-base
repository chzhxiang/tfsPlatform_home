...
import com.asiainfo.tfsPlatform.modules.test.selenium.Selenium2;
import com.asiainfo.tfsPlatform.modules.test.selenium.SeleniumSnapshotRule;
import com.asiainfo.tfsPlatform.modules.test.selenium.WebDriverFactory;
