...
public class TfBTradeUserDto implements Serializable {
    ...
    private Integer basicCreditValue;
    ...
    public Integer getUsecustId() {
        return usecustId;
    }

    public void setUsecustId(Integer usecustId) {
    ...
    public Integer getBasicCreditValue() {
        return basicCreditValue;
    }

    public void setBasicCreditValue(Integer basicCreditValue) {
    ...
    public Integer getAssureCustId() {
        return assureCustId;
    }

    public void setAssureCustId(Integer assureCustId) {
