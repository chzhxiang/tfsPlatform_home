...
<link href="${ctx}/static/css/H-ui.login.css" rel="stylesheet" type="text/css" />
    ...
    <form class="form form-horizontal" action="${ctx}/login" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-8">
          <input id="username" name="username" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
...
<div class="footer">Copyright 亚信科技 by 车联网 v1.0</div>
