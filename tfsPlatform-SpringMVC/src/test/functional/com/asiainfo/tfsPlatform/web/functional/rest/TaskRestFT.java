 ...
 *******************************************************************************/
package com.asiainfo.tfsPlatform.web.functional.rest;
...
import com.asiainfo.tfsPlatform.web.functional.BaseFunctionalTestCase;
...
public class TaskRestFT extends BaseFunctionalTestCase {
	...
	@Category(Smoke.class)
	public void getTask() {
		TaskDto task = restTemplate.getForObject(resourceUrl + "/{id}", TaskDto.class, 1L);
	...
	private static class TaskList extends ArrayList<TaskDto> {
	}
}
